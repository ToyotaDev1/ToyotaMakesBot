...
exports.conf = {
	enabled: true,
	guildOnly: false,
	aliases: ['CSGO', 'CS: GO', 'CSGOstats','csgo-stats'],
	permLevel: 0
};

exports.help = {
	name: 'csgo',
	description: 'Using this command you are able to get stats about yours or someone elses Counter Strike: Global Offensive account.',
	usage: 'csgo [account name or STEAM ID]'
};